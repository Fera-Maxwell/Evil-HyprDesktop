...
echo -e "${WHITE}Make sure you have installed the required dependencies listed on the GitHub page.${RESET}"
echo -e "${WHITE}Log out and select 'Hyprland' to see your new desktop.${RESET}"
